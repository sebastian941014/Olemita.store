      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-3xl font-bold mb-4 font-serif">OLÉ MITA</h3>
            <p className="text-gray-400 mb-6">
              Sodas artesanales que transforman cada sorbo en una experiencia tropical inolvidable.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-start">
                ...
                <span>Ciudad Cúcuta</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500">
          <p>© {new Date().getFullYear()} Olé Mita. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
